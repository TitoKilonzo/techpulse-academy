...
export function logError(context, err) {
  ...
  // Surface a clear hint for the most common deployment issue
  if (err?.code === 'TURSO_ALLOWLIST') {
    console.error(
      '[TechPulse] ACTION REQUIRED: Turso allowlist is blocking connections. ' +
      'Go to https://app.turso.tech → your database → Settings → Allowed IPs ' +
      'and disable the allowlist OR add your server IP.'
    );
  }
}
